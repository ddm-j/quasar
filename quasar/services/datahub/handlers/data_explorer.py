"""Data Explorer API handlers: search, OHLC retrieval, metadata."""
import logging
...
class DataExplorerHandlersMixin(HandlerMixin):
    """Mixin providing Data Explorer API endpoints for DataHub."""
