...
class TestSearchSymbols:
    """Tests for handle_search_symbols endpoint."""
...
class TestGetOHLCData:
    """Tests for handle_get_ohlc_data endpoint."""
...
class TestGetSymbolMetadata:
    """Tests for handle_get_symbol_metadata endpoint."""
...
class TestProviderInUse:
    """Tests for provider usage tracking."""
